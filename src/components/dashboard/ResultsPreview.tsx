...
export function ResultsPreview() {
  ...
  return (
    <div
      ref={container}
      className="relative w-full max-w-6xl mx-auto py-12 md:py-24 px-8 md:px-12 z-20"
    >
      <div className="mb-16 text-center flex flex-col items-center">
        <span className="text-sm font-medium text-[#3054ff] uppercase tracking-widest bg-[#3054ff]/10 px-3 py-1 rounded-full border border-[#3054ff]/20">
          The Output
        </span>
        <h2
        ...
        <p className="mt-4 text-white/80 max-w-xl text-sm leading-relaxed">
          The moment your interview concludes, our neural engine synthesizes a comprehensive,
        ...
        <div className="grid gap-6 lg:gap-8 lg:grid-cols-12">
          ...
          <div className="lg:col-span-8 space-y-6">
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Bar dataKey="value" radius={[0, 4, 4, 0]} barSize={16}>
                        {previewEmotionData.map((entry, i) => (
            ...
            <div className="bg-[#0a0a1a]/40 backdrop-blur-md border border-white/5 rounded-2xl p-6 relative overflow-hidden group transition-all duration-300 hover:border-white/10">
              ...
              <p className="text-sm leading-relaxed text-white/90 italic relative z-10">
                "I spearheaded the cloud migration initiative, reducing operational costs by 30%
                while ensuring zero downtime during the transition. My primary focus was on..."
              </p>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-[#0a0a1a]/40 backdrop-blur-md border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-center text-center group transition-all duration-300 hover:border-white/10">
              <span className="text-xs font-semibold uppercase tracking-widest text-white/80 mb-4 block w-full text-left">
                Vocal Confidence
              </span>
              ...
              <div className="relative grid place-items-center mb-2 mt-2">
                ...
                <div className="absolute text-center">
                  ...
                  <div className="mt-1 text-[10px] uppercase tracking-widest text-white/90 tabular-nums">
                    95%
                  </div>
                </div>
              </div>
            ...
            <div className="bg-[#0a0a1a]/40 backdrop-blur-md border border-white/5 rounded-2xl p-6 group transition-all duration-300 hover:border-white/10">
              ...
              <ul className="space-y-3 text-sm text-white/85">
                <li className="flex gap-2">
                  <span className="text-emerald-500 shrink-0">›</span>Highly relevant to technical
                  topic.
                </li>
                <li className="flex gap-2">
                  <span className="text-emerald-500 shrink-0">›</span>Positive and confident
                  delivery.
                </li>
              </ul>
              ...
              <p className="text-sm text-white/85 leading-relaxed">
                Pacing was perfect. Try maintaining slightly more eye contact when explaining
                complex metrics.
              </p>
            </div>
          </div>
