  ...
  head: () => ({
    meta: [
      { title: "New Analysis — AI Interview Evaluator" },
      {
        name: "description",
        content:
          "Upload a video or record live to evaluate your interview performance with multimodal AI.",
      },
    ],
  }),
  component: () => (
...
function AnalyzePage() {
  ...
  const analyze = async () => {
    if (!file) {
      toast.error("Please upload or record an interview file first");
      return;
    }
    ...
    try {
      ...
      if (!response.ok) {
        ...
        try {
          ...
          detail = text.substring(0, 200) || `HTTP ${response.status}`;
        }
            ...
            >
              ...
              <section className="relative w-full pt-32 pb-10 px-8 md:px-28">
                <div className="max-w-5xl mx-auto">
                  ...
                  >
                    Upload a video or record live. The neural engine dissects speech, facial affect,
                    and language — fusing them into a single objective score.
                  </motion.p>
                </div>
              </section>
                              ...
                              <div className="relative flex flex-col items-center gap-4">
                                <div className="relative">
                                  ...
                                  <motion.div
                                    ...
                                    animate={{
                                      opacity: isDragging ? [0.3, 0.7, 0.3] : [0.05, 0.15, 0.05],
                                      scale: isDragging ? [0.9, 1.1, 0.9] : [0.95, 1.05, 0.95],
                                    }}
                                    transition={{
                                      duration: 2.5,
                                      repeat: Infinity,
                              ...
                              {recordState !== "recording" && (
                                <div className="flex flex-col items-center gap-4 text-center">
                                  ...
                                  <p className="text-sm text-white/35">
                                    {recordState === "stopped"
                                      ? "Recording saved — see upload panel."
                      ...
                      <div className="flex items-center gap-3 mb-5">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-white/35">
                            Used for semantic relevance scoring
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="space-y-6">
                    ...
                    >
                      {processHighlights.map((h, i) => (
                        ...
                        >
                          ...
                          <h.icon
                            className="w-5 h-5 text-[var(--brand-blue)] group-hover:text-white relative z-10 transition-colors duration-300"
                            strokeWidth={1.5}
                          />
                          <div className="relative z-10 min-w-0 break-words">
                            <p className="text-[12px] font-semibold text-white/80 group-hover:text-white transition-colors truncate">
                              {h.title}
                            </p>
                            <p className="text-[10px] text-white/40 group-hover:text-white/60 transition-colors leading-tight mt-0.5 line-clamp-2">
                              {h.desc}
                            </p>
                          </div>
                        </motion.div>
                    ...
                    >
                      <div className="flex items-center gap-2 mb-5">
                        <span className="h-1.5 w-1.5 rounded-full bg-[var(--brand-blue)] animate-pulse" />
                        <h4 className="text-xs font-semibold text-white/80 uppercase tracking-widest">
                          Processing Notes
                        </h4>
                      </div>
                      ...
                      <ul className="space-y-4">
                        {[
                          {
                            icon: "🎙️",
                            tip: "Ensure clear audio. Whisper transcription performs best without heavy background noise.",
                          },
                          {
                            icon: "👀",
                            tip: "Keep face visible. The CNN evaluates frame-by-frame facial affect.",
                          },
                          {
                            icon: "⏱️",
                            tip: "First cold-start may take 2–5 min while neural models load into memory.",
                          },
                        ].map((item, i) => (
                          <motion.li
                            key={i}
                      ...
                      <div className="mt-5 p-3.5 rounded-xl border border-white/5 bg-white/[0.02] text-xs text-white/35 leading-relaxed">
                        ...
                        Videos are processed locally or in memory and discarded immediately after
                        feature extraction.
                      </div>
                    </motion.div>
              ...
              <section className="relative py-12 md:py-16 px-8 md:px-28 z-20">
                <div className="max-w-5xl mx-auto">
                  ...
                  >
                    ...
                    <h2
                      className="mt-6 text-3xl md:text-4xl font-semibold tracking-tighter"
                      style={{ fontFamily: "var(--font-serif)" }}
                    >
                      From Video to Verdict.
                    </h2>
                    <p className="mt-3 text-white/40 text-sm max-w-lg mx-auto leading-relaxed">
                      Four parallel neural pipelines process your interview in real-time, fusing
                      signals into a single objective evaluation.
                    </p>
                  </motion.div>
                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-4 relative z-10">
                      {[
                        ...
                        { icon: Eye, title: "Facial Emotion", desc: "Frame-by-frame CNN affect" },
                        {
                          ...
                          title: "NLP Engine",
                          desc: "Semantic context scoring",
                        },
                        {
                          icon: Network,
                          title: "Neural Fusion",
                          desc: "Cross-modal ANN synthesis",
                        },
                        ...
                        >
                          ...
                          <div className="min-w-0 flex-1 break-words">
                            ...
                            <p className="text-[11px] text-white/40 leading-tight mt-1 group-hover:text-white/65 transition-colors line-clamp-2">
                              {step.desc}
                            </p>
                          </div>
                        </motion.div>
