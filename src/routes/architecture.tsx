...
const stages = [
  {
    ...
    title: "Input Video",
    sub: "MP4 / MOV / WAV",
    color: "from-[var(--brand-blue)]/80 to-[var(--brand-blue)]/40",
  },
  {
    icon: AudioLines,
    title: "Speech Pipeline",
    sub: "Whisper + MFCC",
    color: "from-[var(--brand-blue)] to-white/20",
  },
  {
    icon: Eye,
    title: "Vision Pipeline",
    sub: "CNN · FER-2013",
    color: "from-white/20 to-[var(--brand-blue)]",
  },
  {
    icon: MessageSquareText,
    title: "NLP Pipeline",
    sub: "DistilBERT",
    color: "from-[var(--brand-blue)] to-[var(--brand-blue)]/50",
  },
  {
    icon: Network,
    title: "Fusion ANN",
    sub: "Multimodal merge",
    color: "from-[var(--brand-blue)]/50 to-[var(--brand-blue)]",
  },
  {
    icon: Sparkles,
    title: "Final Score + Confidence",
    sub: "Calibrated softmax",
    color: "from-[var(--brand-blue)] to-white/50",
  },
];
      ...
      <div className="relative z-10 px-8 md:px-28 pt-32 pb-10">
        <div className="mx-auto max-w-5xl space-y-16 md:space-y-24">
          ...
          >
            ...
            >
              System <span className="text-[var(--brand-blue)]">Architecture</span>
            </h1>
            <p className="mt-4 text-lg text-white/60 leading-relaxed max-w-2xl">
              A neural data flow from raw input to fused decision.
            </p>
          </motion.div>
          ...
          <div className="space-y-2">
            {stages.map((s, i) => (
              <div key={s.title}>
                ...
                >
                  <div
                    className={`grid h-14 w-14 shrink-0 place-items-center rounded-xl bg-gradient-to-br ${s.color} shadow-[0_0_20px_rgba(48,84,255,0.2)]`}
                  >
                  ...
                  <div className="hidden text-xs uppercase tracking-widest text-white/30 md:block shrink-0">
                    stage {i + 1}
                  </div>
                </motion.div>
                {i < stages.length - 1 && (
          ...
          <motion.div
            ...
            className="bg-card/40 backdrop-blur-xl border border-white/5 bg-gradient-to-br from-white/[0.04] to-transparent hover:border-[var(--brand-blue)]/30 hover:shadow-[0_0_30px_rgba(48,84,255,0.15)] transition-all duration-300 relative group"
          >
            <div className="p-6">
              ...
              <p className="mt-2 text-sm text-white/70 leading-relaxed min-w-0 break-words">
                Each modality alone is fragile: speech misses context, vision misses content, NLP
                misses delivery. The fusion ANN learns the weights between them so the final signal
                is more robust than any single channel.
              </p>
            </div>
          </motion.div>
        </div>
